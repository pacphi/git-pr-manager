...
func HandleConfigResource(_ context.Context, request mcp.ReadResourceRequest) ([]mcp.ResourceContents, error) {
...
func HandleRepositoryStatsResource(_ context.Context, request mcp.ReadResourceRequest) ([]mcp.ResourceContents, error) {
	configFile := "config.yaml"
...
func HandleMakefileTargetsResource(_ context.Context, request mcp.ReadResourceRequest) ([]mcp.ResourceContents, error) {
...
func HandleEnvironmentStatusResource(_ context.Context, request mcp.ReadResourceRequest) ([]mcp.ResourceContents, error) {
